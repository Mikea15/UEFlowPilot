...
Changing the Spawn Lifetime, meant that depending on which kind of Lifetime you want, FlowPilot can automatically destroy what was spawned (i.e. `FlowPilot` lifetime), 
